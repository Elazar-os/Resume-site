...
const PHOTOS = {
  professional: [
    { src: "/photos/profile-formal.jpg", alt: "Professional photo 1" },
    { src: "/photos/with-friend.jpg", alt: "Professional photo 2" },
    { src: "/photos/torah-writing.jpg", alt: "Professional photo 3" }
  ],
  dating: [
    { src: "/photos/profile-formal.jpg", alt: "Dating photo 1" },
    { src: "/photos/with-friend.jpg", alt: "Dating photo 2" },
    { src: "/photos/torah-writing.jpg", alt: "Dating photo 3" }
  ]
};
